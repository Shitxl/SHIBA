  ...
  return (
    <div className="bg-gray-100 px-[200px] h-[60vh] mt-[40px]">
      ...
      <div className="flex justify-between py-[5%]">
        <div>
          <img src="/logo2.png" alt="" height={200} width={200} />
          <p className="mt-2">
        ...
        <div className="w-full md:w-1/3">
          ...
          <p className="mt-2">123 ShibaBeauty Ave, City, Country</p>
          <p className="mt-2">Phone: (+91) 8007576984</p>
          <p className="mt-2">Email: info@Shibabeauty.com</p>
        </div>
